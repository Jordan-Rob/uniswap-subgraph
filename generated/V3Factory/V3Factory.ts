...
export class V3Factory__parametersResult {
  value0: Address;
  value1: Address;
  value2: Address;
  value3: i32;
...
export class V3Factory extends ethereum.SmartContract {
  static bind(address: Address): V3Factory {
    return new V3Factory("V3Factory", address);
  }
  ...
  parameters(): V3Factory__parametersResult {
    let result = super.call(
      "parameters",
    ...
    return new V3Factory__parametersResult(
      result[0].toAddress(),
      result[1].toAddress(),
      result[2].toAddress(),
      result[3].toI32(),
  ...
  try_parameters(): ethereum.CallResult<V3Factory__parametersResult> {
    let result = super.tryCall(
      "parameters",
      "parameters():(address,address,address,uint24,int24)",
      []
    ...
    return ethereum.CallResult.fromValue(
      new V3Factory__parametersResult(
        value[0].toAddress(),
        value[1].toAddress(),
        value[2].toAddress(),
        value[3].toI32(),
